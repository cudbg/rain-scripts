...
data = read.csv("figure_11.csv")
basedata = read.csv("figure_11_base.csv")
...
ggsave(
    "../assets/[RC]MNISTCountWrongComplaint-1-7-LogReg-10000-0.3.png"
    ,p, width=7, height=3, scale=0.8
)
